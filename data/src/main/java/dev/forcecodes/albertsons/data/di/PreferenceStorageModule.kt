...
import dev.forcecodes.albertsons.data.preference.DataStorePreferenceStorage
...
abstract class PreferenceStorageModule {
    @Binds
    abstract fun providesPreferenceStorage(datastore: DataStorePreferenceStorage): PreferenceStorage
}
